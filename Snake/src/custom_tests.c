...
bool test_body_to_tail() {
    ...
    char testcase_1 = 'v';
    char expected = 's';
    char actual = body_to_tail(testcase_1);
    if (!assert_equals_char("output_1", expected, actual)) {
        return false;
    }
...
bool test_head_to_body() {
    ...
    char testcase_1 = 'W';
    char expected = '^';
    char actual = head_to_body(testcase_1);
    if (!assert_equals_char("output_1", expected, actual)) {
        return false;
    }
...
bool test_get_next_row() {
  ...
  unsigned int actual = get_next_row(2, 'D');
  if (!assert_equals_unsigned_int("output_1", expected, actual)) {
      return false;
  }
...
bool test_get_next_col() {
  ...
  unsigned int actual = get_next_col(4, 'D');
  if (!assert_equals_unsigned_int("output_1", expected, actual)) {
      return false;
  }
  return true;
